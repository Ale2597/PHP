...
{
   $query = "SELECT e.est_id, e.nombre, e.apellido1, e.apellido2, e.email, e.depto_id, e.promedio
			FROM estudiante2 e
...
else if(isset($_POST['est_id']) && is_numeric($_POST['est_id']))
{
      ...
      $query = "UPDATE estudiante2 SET apellido1='$apellido_paterno', apellido2='$apellido_materno', 
